...
export default function HeaderRAC() {
  return (
    <div className="w-full h-[650px] xs:h-[700px] sm:h-[720px] flex justify-center mt-10 ">
      ...
      <div className="w-full sm:w-8/12 lg:w-9/12 flex flex-col-reverse sm:flex-col lg:flex-row bg-[url('/img/fondoHeaderResp.webp')] sm:bg-[url('/img/fondoHeader.webp')] bg-cover bg-no-repeat bg-bottom sm:bg-left-bottom sm:pl-20 lg:pl-0">
