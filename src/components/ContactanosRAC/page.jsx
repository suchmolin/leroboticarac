...
export default function ContactanosRAC() {
  return (
    <div
      id="contactanos"
      className="w-full flex justify-center items-center py-10 bg-amarilloLR pb-64 xxl:pb-96 bg-[url('/img/fondoContactanosResp.webp')] sm:bg-[url('/img/fondoContactanos.webp')] bg-left-bottom bg-no-repeat bg-contain"
    >
